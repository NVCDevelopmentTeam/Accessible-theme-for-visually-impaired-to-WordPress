...
                                            <img src='<?php bloginfo('stylesheet_directory'); 
				<img id="f-image-1" class="featured-image" src="Image_1.jpg" alt="welcom to your theme" />
				<img id="f-image-2" class="featured-image hidden" src="Image_2.jpg" alt="my theme to WordPress" />
				<img id="f-image-3" class="featured-image hidden" src="Image_3.jpg" /alt="create theme accessibility for visually impaired" >
			</div>
		</div>
